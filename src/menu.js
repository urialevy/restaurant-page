export function aboutPg(){
    ...
    aboutBtn.addEventListener('click', function() {
        ...
        <div class="menuItem" id="about"><button class='menuBtn'>Mead Menu</button></div>
        ...
        <p>Honey wine - or mead as it is colloquially called - is one of the first forms of alcohol consumed by humans. We are a collection of home brewers who try to share this ancient tradition with others, using modern tools. Our mead selection includes:</p>
        <div id="menu">
